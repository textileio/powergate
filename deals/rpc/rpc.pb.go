...
func (x *DealRecord) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *RetrievalRecord) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
var file_deals_rpc_rpc_proto_rawDesc = []byte{
	...
	0x0a, 0x44, 0x65, 0x61, 0x6c, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x66,
	...
	0x6f, 0x72, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x18,
