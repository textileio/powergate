...
$(BUF): .bingo/buf.mod
	...
	@cd .bingo && $(GO) build -mod=mod -modfile=buf.mod -o=$(GOBIN)/buf-v0.30.0 "github.com/bufbuild/buf/cmd/buf"
...
$(PROTOC_GEN_GO_GRPC): .bingo/protoc-gen-go-grpc.mod
	...
	@cd .bingo && $(GO) build -mod=mod -modfile=protoc-gen-go-grpc.mod -o=$(GOBIN)/protoc-gen-go-grpc-v1.0.1 "google.golang.org/grpc/cmd/protoc-gen-go-grpc"
...
$(PROTOC_GEN_GO): .bingo/protoc-gen-go.mod
	...
	@cd .bingo && $(GO) build -mod=mod -modfile=protoc-gen-go.mod -o=$(GOBIN)/protoc-gen-go-v1.25.0 "google.golang.org/protobuf/cmd/protoc-gen-go"
