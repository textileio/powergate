...
func init() {
	...
	resumeCmd.Flags().MarkHidden("concurrent")
	resumeCmd.Flags().MarkHidden("max-staged-bytes")
	resumeCmd.Flags().MarkHidden("max-deal-bytes")
	resumeCmd.Flags().MarkHidden("min-deal-bytes")
