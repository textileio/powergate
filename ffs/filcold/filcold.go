...
func (fc *FilCold) EnsureRenewals(ctx context.Context, c cid.Cid, inf ffs.FilInfo, cfg ffs.FilConfig, dealFinalityTimeout time.Duration, dealUpdates chan<- ffs.FilStorage) (ffs.FilInfo, []ffs.DealError, error) {
...
func (fc *FilCold) renewDeal(ctx context.Context, c cid.Cid, size uint64, p ffs.FilStorage, fcfg ffs.FilConfig, waitDealTimeout time.Duration, dealUpdates chan<- ffs.FilStorage) (ffs.FilStorage, error) {
	f := ffs.MinerSelectorFilter{
...
func (fc *FilCold) WaitForDeal(ctx context.Context, c cid.Cid, proposal cid.Cid, timeout time.Duration, dealUpdates chan<- ffs.FilStorage) (ffs.FilStorage, error) {
