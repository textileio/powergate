...
// QueryStorageInfo returns a list of StorageInfo matching any provided query options.
func (s *Scheduler) QueryStorageInfo(iids []ffs.APIID, cids []cid.Cid) ([]ffs.StorageInfo, error) {
	return s.cis.Query(iids, cids)
}
